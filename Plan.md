...
Не валидные данные – любые данные, отличающиеся от валидных.
...
4.1. Планирование автоматизации тестирования (подготовка тестовых сценариев и определение рисков) – 8 часов
4.2. Автоматизация тестовых сценариев – 8 часов
4.3. Подготовка отчётных документов по итогам тестирования – 5 часов
4.4. Подготовка отчётных документов по итогам автоматизации – 3 часа
4.5. Преодоление рисков – 6 часов



## 5. План сдачи работ

5.1. Планирование автоматизации тестирования –14.01
5.2. Автоматизация тестовых сценариев – 23.01
5.3. Подготовка отчётных документов по итогам тестирования – 26.01
5.4. Подготовка отчётных документов по итогам автоматизации – 29.01